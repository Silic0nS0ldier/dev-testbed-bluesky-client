...
bazel build \
    ...
    //build_defs/lightningcss_bundle:node_modules \
    //vendor:node_modules \
...
rm -rf ./build_defs/lightningcss_bundle/node_modules
...
cp -r ./.bazel/bin/build_defs/lightningcss_bundle/node_modules ./build_defs/lightningcss_bundle/
